...
class Adam:
    ...
    def evaluate(self, weights):
        ...
        loss, grads, l1, l2, l3 = self.Loss(self.x_train, self.y_train, self.a_g, self.a_b1, self.a_b2)
        self.his_l1.append(l1.numpy())
        self.his_l2.append(l2.numpy())
        self.his_l3.append(l3.numpy())
        if self.iter % 200 == 0:
            self.a_g, self.a_b1, self.a_b2, jac = cal_adapt(self.pirbn, self.x_train)
    ...
    def fit(self):
        ...
        return np.array(self.his_l1)+np.array(self.his_l2)+np.array(self.his_l3), [self.his_l1, self.his_l2, self.his_l3]